...
> 本项目为 http://github.com/CCZX/wechat 
> 维护项目;
- 如在阅读原作者**文档**、观看**视频**后任有问题可以加原作者群或者本人 `QQ` 。
...
```bash
git clone git@github.com:ZiHaoMC/wechat.git
```
...
1. 客户端的代码打包后资源默认放在`chatServer`文件夹的`public`目录下；
   文字教程地址(必看):https://www.jianshu.com/p/83b76e62976b
